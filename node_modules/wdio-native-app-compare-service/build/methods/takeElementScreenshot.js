...
var _takeResizedElementScreenshot = require("./takeResizedElementScreenshot");
 ...
 * @private
 */
async function takeElementScreenshot(element, filePath) {
...
`);
    ...
    return (0, _takeResizedElementScreenshot.takeResizedElementScreenshot)(element, filePath);
  }
}