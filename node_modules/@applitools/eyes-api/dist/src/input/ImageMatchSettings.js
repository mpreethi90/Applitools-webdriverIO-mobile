...
class ImageMatchSettingsData {
    ...
    set accessibilitySettings(accessibilitySettings) {
        if (accessibilitySettings) {
            ...
            utils.guard.isEnumValue(level, AccessibilityLevel_1.AccessibilityLevel, { name: 'accessibilitySettings.level' });
            utils.guard.isEnumValue(guidelinesVersion, AccessibilityGuidelinesVersion_1.AccessibilityGuidelinesVersion, {
