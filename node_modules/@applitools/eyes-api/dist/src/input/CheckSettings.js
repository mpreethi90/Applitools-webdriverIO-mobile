...
class CheckSettingsFluent {
    ...
    accessibilityRegion(region, type) {
        ...
        utils.guard.isEnumValue(accessibilityRegion.type, AccessibilityRegionType_1.AccessibilityRegionType, {
            name: 'type',
            strict: false,
        });
    ...
    accessibilityRegions(regionOrType, ...regions) {
        if (utils.types.isEnumValue(regionOrType, AccessibilityRegionType_1.AccessibilityRegionType)) {
    ...
    matchLevel(matchLevel) {
        utils.guard.isEnumValue(matchLevel, MatchLevel_1.MatchLevel, { name: 'matchLevel' });
        this._settings.matchLevel = matchLevel;
        return this;
    }
    layout() {
        this._settings.matchLevel = MatchLevel_1.MatchLevel.Layout;
        return this;
    }
    exact() {
        this._settings.matchLevel = MatchLevel_1.MatchLevel.Exact;
        return this;
    }
    strict() {
        this._settings.matchLevel = MatchLevel_1.MatchLevel.Strict;
        return this;
    }
    content() {
        this._settings.matchLevel = MatchLevel_1.MatchLevel.Content;
        return this;
    }
    useDom(useDom = true) {
