...
class ConfigurationData {
    ...
    set stitchMode(stitchMode) {
        utils.guard.isEnumValue(stitchMode, StitchMode_1.StitchMode, { name: 'stitchMode' });
    ...
    addBrowser(browserInfoOrWidth, height, name = BrowserType_1.BrowserType.CHROME) {
    ...
    addDeviceEmulation(deviceName, screenOrientation = ScreenOrientation_1.ScreenOrientation.PORTRAIT) {
        if (!this.browsersInfo)
            this.browsersInfo = [];
