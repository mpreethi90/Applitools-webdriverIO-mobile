        ...
        for (const result of results) {
            ...
            if (container.testResults) {
                if (container.testResults.status) {
                    if (container.testResults.status === TestResultsStatus_1.TestResultsStatus.Failed)
                        this._failed += 1;
                    else if (container.testResults.status === TestResultsStatus_1.TestResultsStatus.Passed)
                        this._passed += 1;
                    else if (container.testResults.status === TestResultsStatus_1.TestResultsStatus.Unresolved)
                        this._unresolved += 1;
                }
