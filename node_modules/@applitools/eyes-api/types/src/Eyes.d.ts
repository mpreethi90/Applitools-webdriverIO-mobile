...
import { SessionTypeLiteral } from './enums/SessionType';
...
import { LogHandlerData } from './input/LogHandler';
...
export declare class Eyes<TDriver = unknown, TElement = unknown, TSelector = unknown> {
    ...
    private _events;
    private _handlers;
    static setViewportSize(driver: unknown, viewportSize: RectangleSize): Promise<void>;
    ...
    open(driver: TDriver, config?: Configuration): Promise<TDriver>;
    open(driver: TDriver, appName?: string, testName?: string, viewportSize?: RectangleSize, sessionType?: SessionTypeLiteral): Promise<TDriver>;
    /** @deprecated */
    checkWindow(name?: string, timeout?: number, fully?: boolean): Promise<MatchResultData>;
    /** @deprecated */
    checkFrame(element: TElement | TSelector | string | number, timeout?: number, name?: string): Promise<MatchResultData>;
    /** @deprecated */
    checkElement(element: TElement, timeout?: number, name?: string): Promise<MatchResultData>;
    /** @deprecated */
    checkElementBy(selector: TSelector, timeout?: number, name?: string): Promise<MatchResultData>;
    /** @deprecated */
    ...
    /** @deprecated */
    checkRegionBy(selector: TSelector, name?: string, timeout?: number, fully?: boolean): Promise<MatchResultData>;
    /** @deprecated */
    checkRegionInFrame(frame: TElement | TSelector | string | number, selector: TSelector, timeout?: number, name?: string, fully?: boolean): Promise<MatchResultData>;
    ...
    extractText(regions: OCRRegion<TElement, TSelector>[]): Promise<string[]>;
    ...
    setViewportSize(viewportSize: RectangleSize): Promise<void>;
    getScrollRootElement(): TElement | TSelector;
    setScrollRootElement(scrollRootElement: TElement | TSelector): void;
    setLogHandler(handler: LogHandlerData): void;
