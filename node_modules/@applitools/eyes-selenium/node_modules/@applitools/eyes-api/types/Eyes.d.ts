...
export declare class Eyes<TDriver = unknown, TElement = unknown, TSelector = unknown> {
    ...
    open(driver: TDriver, appName?: string, testName?: string, viewportSize?: RectangleSize, sessionType?: SessionTypeEnum): Promise<TDriver>;
    /** @deprecated */
    ...
    setMatchLevel(matchLevel: MatchLevelEnum): void;
    ...
    setStitchMode(stitchMode: StitchModeEnum): void;
